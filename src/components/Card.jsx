  ...
  return (
    <div className='md:w-[30%] rounded-md p-3 text-white w-full bg-zinc-800'>
        <div className='flex justify-between mb-10'>
            <h3 className="flex flex-col text-3xl font-semibold"> {icon} {title}</h3>
            <span className='flex items-center'><GoDotFill className='text-green-600' />{online} </span>
        </div>
        <div className="flex flex-col gap-2">
            <ul>
                <li className="list-disc ml-5">{rules[0]}</li>
